...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        bool isUpdated = await zoomService.UpdateMeetingAsync(accessToken, meetingId, new MeetingBodyRequest("Updated555", DateTime.UtcNow.AddHours(1), 45, "nothing", Hackathon.Domain.Enums.TimeZones.UTC));
